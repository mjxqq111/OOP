        ...
        wxDefaultPosition, wxSize(800, 600))
{
    ...
    m_pluginsBtn = new wxButton(m_controlPanel, 2002, "Plugins");
    controlSizer->Add(m_pluginsBtn, 0, wxALL, 3);

    m_clearBtn = new wxButton(m_controlPanel, 2003, "Clear All");
    controlSizer->Add(m_clearBtn, 0, wxALL, 3);

    // Save and load buttons
    m_saveBtn = new wxButton(m_controlPanel, 2004, "Save Canvas");
    controlSizer->Add(m_saveBtn, 0, wxALL, 3);

    m_loadBtn = new wxButton(m_controlPanel, 2005, "Load Canvas");
